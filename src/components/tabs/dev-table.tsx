...
export function DevTable({ sites, stats, latest }: {
  ...
  return (
    <div className="overflow-x-auto -mx-4 px-4">
      <table className="text-[11px] font-mono border-collapse" style={{ width: "375px", tableLayout: "fixed" }}>
        <thead>
          <tr className="text-[10px] text-zinc-400 dark:text-zinc-500 border-b border-zinc-100 dark:border-zinc-800">
            <th className="text-left font-medium py-1.5 pr-2 sticky left-0 bg-white dark:bg-zinc-950" style={{ width: "130px" }}>사이트</th>
            <th className="text-left font-medium py-1.5 pr-2" style={{ width: "35px" }}>파일</th>
            <th className="text-left font-medium py-1.5 pr-2" style={{ width: "80px" }}>
